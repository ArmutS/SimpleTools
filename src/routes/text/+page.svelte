<script lang="ts">
    ...
    let tools = [
        { id: "diff", name: "Diff Viewer", icon: "nf-seti-text" },
        { id: "regex", name: "Regex Tester", icon: "nf-seti-pdf" },
        {
            id: "extractor",
            name: "Extractor",
            icon: "nf-md-file_arrow_left_right_outline",
        },
        { id: "strip", name: "Strip HTML Tags", icon: "nf-oct-file" },
        { id: "string", name: "String Escaper / Unescaper", icon: "nf-fa-image" },
        { id: "slug", name: "Slug Generator", icon: "nf-md-console_network" },
        { id: "jwt", name: "JWT Decoder", icon: "nf-dev-devicon" },
        { id: "cron", name: "Cron Expression Explainer", icon: "nf-oct-command_palette" },
        { id: "markdown", name: "Markdown Preview", icon: "nf-fae-comet" },
        { id: "lorem", name: "Lorem Ipsum Generator", icon: "nf-fae-comet" },
        { id: "text", name: "Text Obfuscator / Rot13", icon: "nf-fae-comet" },
        { id: "character", name: "Character Inspector", icon: "nf-fae-comet" },
    ];
