<script lang="ts">
  // Logic ve Rust bağlantıları senin ellerinden öper...
</script>
    ...
    <div class="matches-container">
      <div class="match-card">
        <div class="match-header">
          <span class="match-index">#1</span>
          <span class="match-range">Indices: [0-5]</span>
        </div>
      ...
      <div class="match-card">
        <div class="match-header">
          <span class="match-index">#2</span>
          <span class="match-range">Indices: [12-17]</span>
        </div>
        <div class="match-content">
